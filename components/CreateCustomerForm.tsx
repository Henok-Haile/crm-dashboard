...
export default function CreateCustomerForm({ onCustomerAdded }: { onCustomerAdded: () => void }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="bg-blue-600 text-white hover:bg-blue-700">+ Add Customer</Button>
      </DialogTrigger>
      <DialogContent className="bg-white shadow-lg rounded-lg p-6">
        <DialogHeader>
          <DialogTitle className="text-lg font-semibold">Add a New Customer</DialogTitle>
        </DialogHeader>
